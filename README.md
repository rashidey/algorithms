...
* [**Backtracking**](/algorithms/backtracking)  
    ...
    - [Combinations Sum Four](/algorithms/backtracking/combinations_sum_four.py)  
    ...
    - [Palindrome Partition](/algorithms/backtracking/palindrome_partition.py)  
    ...
    - [Restore Ip Addresses](/algorithms/backtracking/restore_ip_addresses.py)  
...
* [**Binarysearch**](/algorithms/binarysearch)  
    ...
    - [Sum Square Numbers](/algorithms/binarysearch/sum_square_numbers.py)  
...
* [**Bits**](/algorithms/bits)  
    ...
    - [Bitwise And Range](/algorithms/bits/bitwise_and_range.py)  
    ...
    - [Gray Code](/algorithms/bits/gray_code.py)  
    - [Is One Bit Character](/algorithms/bits/is_one_bit_character.py)  
    - [Max Product Word Lengths](/algorithms/bits/max_product_word_lengths.py)  
    ...
    - [Single Number Iii](/algorithms/bits/single_number_III.py)  
...
* [**Graphs**](/algorithms/graphs)  
    ...
    - [Shortest Path Binary Matrix](/algorithms/graphs/shortest_path_binary_matrix.py)  
    ...
    - [Water And Jug](/algorithms/graphs/water_and_jug.py)  
...
* [**Hash Tables**](/algorithms/hashtables)  
    ...
    - [Longest Consecutive Sequence](/algorithms/hashtables/longest_consecutive_sequence.py)  
...
* [**Heaps**](/algorithms/heaps)  
    ...
    - [Sliding Window Median](/algorithms/heaps/sliding_window_median.py)  
...
* [**Linked List**](/algorithms/linkedlist)  
    ...
    - [Linked List Random](/algorithms/linkedlist/linked_list_random.py)  
...
* [**Math**](/algorithms/math)  
    ...
    - [Divisor Game](/algorithms/math/divisor_game.py)  
    ...
    - [Max Points On Line](/algorithms/math/max_points_on_line.py)  
...
* [**Sort**](/algorithms/sort)  
    ...
    - [Lexical Numbers](/algorithms/sort/lexical_numbers.py)  
...
* [**Strings**](/algorithms/strings)  
    ...
    - [Gcd Of String](/algorithms/strings/gcd_of_string.py)  
    ...
    - [Number Of Lines To Write String](/algorithms/strings/number_of_lines_to_write_string.py)  
    - [Number Of Segments String](/algorithms/strings/number_of_segments_string.py)  
    - [Occurances After Bigram](/algorithms/strings/occurances_after_bigram.py)  
    ...
    - [Remove Duplicate Letters](/algorithms/strings/remove_duplicate_letters.py)  
    ...
    - [Shortest Palindrome](/algorithms/strings/shortest_palindrome.py)  
